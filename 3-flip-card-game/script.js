const cards = document.querySelectorAll('.card'),
    ...
    refreshBtn = document.querySelector('.control button');
...
function shuffleCards() {
    ...
    let arr = ['bxs-rocket', 'bxs-lemon', 'bxs-palette', 'bxs-smile', 'bxs-hot', 'bxs-music', 'bxs-rocket', 'bxs-lemon', 'bxs-palette', 'bxs-smile', 'bxs-hot', 'bxs-music'];
